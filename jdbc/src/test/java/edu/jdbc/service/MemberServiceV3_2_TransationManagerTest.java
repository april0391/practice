...
class MemberServiceV3_2_TransationManagerTest {

    DataSource dataSource;
    MemberRepositoryV3_DataSource_Transaction memberRepository;
    MemberServiceV3_2_TransactionManager memberService;
    ...
    void init() throws SQLException {
        ...
        memberService = new MemberServiceV3_2_TransactionManager(memberRepository,transactionManager);
        deleteAll();
    }
